...
const LoadGame = () =>{
  wins.value = parseInt(localStorage.getItem('win')) || 0
  ...
  <div class="bg-gray-700 text-white text-center min-h-screen flex flex-col">
    ...
    <main class="container mx-auto p-6 flex-1">
      <div v-if="choice === null" class="flex items-center justify-center -mx-6">
          ...
          <img src="./assets/RockIcon.svg" alt="Rock" class="w-full h-full">
          </button>
          ...
          <img src="./assets/PaperIcon.svg" alt="Paper" class="w-full h-full">
          </button>
          ...
          <img src="./assets/ScissorsIcon.svg" alt="Scissors" class="w-full h-full">
          </button>
      </div>
      ...
      <div v-else>
        <div class="text-3xl mb-4">
          ...
          <div class="text-3xl mb-4">
            You picked <span class="text-green-500">{{ computerChoice }}</span>
          </div> 
